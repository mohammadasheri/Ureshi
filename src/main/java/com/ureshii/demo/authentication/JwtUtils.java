...
import com.ureshii.demo.user.UreshiiUserDetails;
...
public class JwtUtils {
    ...
    public String generateJwtToken(Authentication authentication) {
        ...
        UreshiiUserDetails userPrincipal = (UreshiiUserDetails) authentication.getPrincipal();
    ...
    public String generateJwtRefreshToken(Authentication authentication) {
        ...
        return Jwts.builder()
                .setSubject((userPrincipal.getUsername()))
                .setIssuedAt(new Date())
                .setExpiration(new Date((new Date()).getTime() + Long.parseLong(refreshTokenDurationMs)))
                .signWith(SignatureAlgorithm.HS256, jwtSecret)
                .compact();
    }
